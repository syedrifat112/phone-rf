...
import reader from '../assets/120538-chatting-illustration.json'
import { ShoppingCartIcon } from '@heroicons/react/24/solid'
import { Link } from 'react-router-dom';

const Home = () => {
    return (
        <div className='my-container flex flex-col items-center justify-between lg:flex-row my-8'>
      {/* Text Content */}
      <div className='mb-10 lg:max-w-lg  lg:pr-5 lg:mb-0'>
        ...
        <div className='flex flex-col items-center md:flex-row'>
          <Link to='/phone' className='btn md:w-auto md:mr-4'>
